...
properties:
  ...
  ack_timeout:
    description: >-
        Time limit for reading a command acknowledgement from the TCP/IP interface
        for most commands (sec)
    type: number
    exclusiveMinimum: 0
  ack_timeout_track_target:
    description: >-
        Time limit for reading a command acknowledgement from the TCP/IP interface
        for main axis and camera cable wrap track target commands (sec)
    type: number
    exclusiveMinimum: 0
