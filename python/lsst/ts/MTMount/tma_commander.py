...
class TmaCommander:
    ...
    def __init__(self, host, log_level, simulate):
        ...
        self.command_dict = dict(
            ...
            az_drive_enable=commands.AzimuthDriveEnable,
            az_drive_reset=commands.AzimuthDriveReset,
            az_enable_tracking=commands.AzimuthEnableTracking,
            az_home=commands.AzimuthHome,
            az_move=commands.AzimuthMove,
            ...
            el_home=commands.ElevationHome,
            el_move=commands.ElevationMove,
